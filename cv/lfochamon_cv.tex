...
\begin{entrydate}
	...
	\entrylist{}{\item Travel grants to major conferences, such as IEEE ICASSP, NeurIPS,
	and~NSDI.}
\end{entrydate}
...
\begin{entrydate}
	\entrydetail{}
		...
		\emph{Source:} DFG (Emmy Noether program) \hfill \emph{Volume:} 1.571.800 \euro}

	\entrydetail{}
		{Data-Driven Decision Making for Constrained Non-Stationary Environments}
		{}
		{\emph{Principal Investigator}\\
		\emph{Co-applicants:} C.\ Vernade (U.\ T\"{u}bingen), G.\ Neu (U.\ Pompeu Fabra, ES),\\
		M.\ Calvo-Fullana (U.\ Pompeu Fabra, ES)\\
		\emph{Source:} DFG-AEI~(Spain) joint call \hfill \emph{Volume:} 537.900 \euro}
\end{entrydate}
...
\begin{entrydate}
	\entrydetail{09/2020--08/2025\\\small(estimated)}
	...
	\entrydetail{09/2017--09/2027\\\small(estimated)}
...
\begin{entrydate}
	...
	\entry{09/2021--present}{Ignacio Hounie \hfill U. Pennsylvania\\
		\emph{(co-supervisor; main supervisor: Prof.\ Dr.\ Alejandro Ribeiro)}}
	\entry{08/2019--09/2022}{Luana Ruiz
		{\small (now assistant professor at John Hopkins U.)}
		\hfill U. Pennsylvania\\
		\emph{(co-supervisor; main supervisor: Prof.\ Dr.\ Alejandro Ribeiro)}}
	\entry{06/2018--07/2021}{Maria Peifer \hfill U. Pennsylvania\\
		\emph{(co-supervisor; main supervisor: Prof.\ Dr.\ Alejandro Ribeiro)}}
\end{entrydate}
...
\begin{entrydate}
	\entry{02/2018--06/2020}
		{Alexandre Amice {\small (now PhD student at MIT)}
		\hfill U. Pennsylvania\\
		\emph{(co-supervisor; main supervisor: Prof.\ Dr.\ Alejandro Ribeiro)}}
\end{entrydate}
...
\switchcolumn
\small\hfill%
(\textbf{Note:} highlighted publications are marked with a\,\,\raisebox{0.9pt}{\tiny\faStar})
\end{paracol}
\vspace{0.2\baselineskip}
