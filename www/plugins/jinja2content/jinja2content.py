...
def add_context_to_readers(generator):
    generator.readers.reader_classes['md'].context = generator.context

def register():
    signals.readers_init.connect(add_reader)
    signals.generator_init.connect(add_context_to_readers)
